          ...
          <>
            <FaqItemComponent question="کلاس‌ها به‌صورت آنلاین برگزار میشن یا ضبط‌شده هستن؟">
              <p>
                ...
                شرکت‌کننده‌ها قرار می‌گیره. بنابراین اگه به هر دلیلی نتونید تو
                جلسات آنلاین شرکت کنید، می‌تونید از محتوای ضبط‌شده استفاده کنید.
              </p>
            </FaqItemComponent>
            <FaqItemComponent question="اگه نتونم آنلاین شرکت کنم، شرکت در این دوره فایده‌ای برام داره؟">
              <p>
                ...
                زمان واستون سوال پیش بیاد میتونید بپرسید. مثلاً وسط جلسه یا در
                جلسات بعدی.
              </p>
              <p>
                اما گروه پرسش‌وپاسخ اختصاصی هم داریم و اگه به هر دلیلی نتونید
                جلسه رو آنلاین شرکت کنید، می‌تونید فیلم ضبط‌شده رو ببینید و داخل
                گروه رفع اشکال کنید.
              </p>
            </FaqItemComponent>
            ...
            <FaqItemComponent question="اگه انصراف بدم، هزینه بهم برگردونده میشه؟">
              <p>
                خیر، امکان عودت وجه بعد از ثبت‌نام وجود نداره. بنابراین لطفاً
                قبل از ثبت‌نام، از تمام شرایط و قوانین آگاهی کسب کنید و با
                اطمینان اقدام کنید.
              </p>
            </FaqItemComponent>
          </>
